...
export const BadgeCounter: React.FC<BadgeCounterProps> = ({
  ...
  return (
    <Container spacing={orientation === 'horizontal' ? 1 : 1} align={orientation === 'horizontal' ? 'center' : 'start'}>
      <Text fontSize="12px" color={MISSION_COLORS.text.secondary} fontWeight="400">
        {label}
      </Text>
      <Badge
        bg={badgeStyles.bg}
